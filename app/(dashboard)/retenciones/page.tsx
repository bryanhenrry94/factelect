...
export default function DocumentsPage() {
  ...
  const handleEdit = (id: string) => {
    router.push(`/retenciones/${id}/editar`);
  };

  const handleAdd = () => {
    router.push("/retenciones/nuevo");
  };
  ...
  useEffect(() => {
    ...
    loadData();
  }, [status, session?.user?.tenantId, search, dateFrom, dateTo, person, type]);
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div>
            ...
            <CardDescription>Listado de retenciones.</CardDescription>
          </div>
          ...
          {documents.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-center space-y-2">
              ...
              <div className="text-lg font-semibold">
                No hay retenciones aún
              </div>
              <div className="text-sm text-muted-foreground">
                Agrega tu primera retención
              </div>
            </div>
          ) : (
            <div>
                  ...
                  {documents
                    ...
                    .map((document) => (
                      <TableRow key={document.id}>
                        ...
                        <TableCell>
                          <Link
                            href={`/retenciones/${document.id}/editar`}
